...
export const authPasswordResetMail = async (options: { resetPassword }) => {
  ...
  width:100%" href="${configurations.datasite.urlClient}/reset-password?token=${
    resetPassword.token
  }">Reset Password</a>
  </td>
  </tr>
  ...
  <a href="${configurations.datasite.urlClient}/reset-password?token=${
    resetPassword.token
  ...
  ${configurations.datasite.urlClient}/reset-password?token=${
    resetPassword.token
  }
  </a></span></p>
